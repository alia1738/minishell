NAME = minishell
SRC = minishell.c get_cmd_path.c simple_helpers1.c simple_helpers2.c execution_utils.c ft_split_custom.c builtins.c builtins1.c builtins2.c parser_utils.c expand_dollar_v2.c pipe_exec.c pipe_exec_utils.c pipe_exec_utils2.c append.c env_export.c env_export_utils.c local_getenv.c free_utils.c memory.c counting_utils.c unset_env.c expand_dollar_utils.c redirections.c single_cmd_exec_utils.c single_cmd_exec.c
OBJ = $(SRC:.c=.o)
DEP = $(SRC:.c=.d)
