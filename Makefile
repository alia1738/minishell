NAME = minishell
SRC = minishell.c get_cmd_path.c simple_helpers.c command_execution.c execution_utils.c ft_split_custom.c builtins.c parser_utils.c expand_dollar_v2.c pipe.c pipe_utils.c pipe_utils2.c env_export.c local_getenv.c free_utils.c memory.c counting_utils.c
OBJ = $(SRC:.c=.o)
DEP = $(SRC:.c=.d)
